...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('user_role', sa.Enum('hr', 'reviewer', 'employee', name='user_role', native_enum=False, length=32), nullable=False),
    ...
    sa.CheckConstraint("user_role IN ('hr', 'reviewer', 'employee')", name=op.f('ck_users_user_role')),
    ...
    sa.Column('actor_role', sa.Enum('hr', 'reviewer', 'employee', name='actor_role', native_enum=False, length=32), nullable=False),
    ...
    sa.CheckConstraint("actor_role IN ('hr', 'reviewer', 'employee')", name=op.f('ck_audit_logs_actor_role')),
